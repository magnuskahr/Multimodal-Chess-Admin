...
class ServoController():
    ...
    def __init__(self, c, modalities):
    ...
    def setLed(self, square, attackable):
        if self.modalities == "ingen" or self.modalities == "magnet":
            return
    ...
    def setForce(self, square: Square, force: Force):
        if self.modalities == "ingen" or self.modalities == "lys":
            return
...
class ServoController():
    ...
    def __init__(self, c, l):
        print("launcher med: ", l)
        if l == "ingen":
            print("INGEN MODALITIES")
        elif l == "lys":
            print("LYS")
        elif l == "magnet": 
            print("magnet")
        elif l == "begge":
            print("ALLE MODALITIES")
